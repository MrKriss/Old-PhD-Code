...
if __name__=='__main__':
  ...
  #-----Fixed-----#
  # Path Setup 
  exp_name = 'Exp-peak_dip2'
  
  results_path = '/home/pgrad/musselle/linux/FRAHST_Project/Results/'
  cwd = os.getcwd()
  ...
  alg_versions = ['F-7.A-recS.R-eng', 'F-7.A-recS.R-eig', 'F-7.A-recS.R-expht' , 'F-7.A-recS.R-static']  
