...
import pickle as pk
import os
from Frahst_v6_5 import rand_sin_trends, FRAHST_V6_5



def rand_sin_trends(N, T, periods, seed = None, noise_scale = 0.1 ):
    
    
    sin_bank = np.zeros((T,len(periods))) #ÃÂ as columns are plotted as default
