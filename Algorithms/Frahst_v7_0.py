...
def FRAHST_V7_0(data, r=1, alpha=0.96, L = 1, holdOffTime=0, evalMetrics = 'F',
    ...
    Version 7.0 - An attempt to cull unused aprts of the algorithm and intergrate it with SAX snapshots.  
                - Functions removed: L for lagging time sereis 
