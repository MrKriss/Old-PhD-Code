...
"""
Code Description: The class that holds all Frahst related Functions

Note: placeholder for final version. This version will be stremlined to only include useful methods.
